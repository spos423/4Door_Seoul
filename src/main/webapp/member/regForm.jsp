...
<body>
	<form action="member.mdo?cmd=regProc" method="post" name="regForm">
		<table border="1" width="100%">
			<tr>
				<td align="center" colspan="2">회원 가입 정보 </td>
			</tr>
	...
	<!-- 		<tr>
				...
				<td><input type="text" id="emailId" name="email"	placeholder="이메일 입력"> 
					<span>@</span> 
					<input id="textEmail" name="email" placeholder="이메일 선택"> 
					<select id="select" name="email" onchange="emailOptionChanged(this)" >
						<option value="" disabled selected>E-Mail 선택</option>
						<option value="naver.com">naver.com</option>
						<option value="hanmail.net">hanmail.net</option>
						<option value="gmail.com">gmail.com</option>
						<option value="directly">직접 입력</option>
				</select></td>
			</tr>
 -->
     ...
     <tr>
			...
			<tr>
				<td colspan="2" align="center"><input type="button"
					value="회원가입" onclick="inputCheck()">&nbsp;&nbsp;</td>
			</tr>
