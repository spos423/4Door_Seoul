...
<body>
	...
	<main class="container-fluid px-0 mb-5" id="main">
		<h5 class="present_location"><img alt="" src="/resources/img/home.png" class="where"> > 여행정보 > 먹거리 > 게시글 작성</h5>
	  	<br>
		...
		<div class="location">
			...
			<div class="board_center">
			  	<form action="t_write_proc.do" method="post" name="boardForm" enctype="multipart/form-data">
				    ...
				    <div class="form-group">
				    	<label for="dish_info" class="label">* 대표 메뉴</label>
				       	<textarea class="form-control dish" rows="30" cols="10" id="dish_info"
				      		      placeholder="대표 메뉴 입력" name="bestmenu"></textarea>
				    </div>
					...
					<input type="button" class="btn" value="게시글 등록" onclick="formCheck2()" />
			    </form>
			</div>
		</div>
