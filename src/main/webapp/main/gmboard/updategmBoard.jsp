...
<body style="display:flex;
 ...
 -->
    ...
    <div class="row">
     ...
     <form action="updategmBoard.do" method="post" enctype="multipart/form-data">
     <table class="table">
       <tr>
        <th class="text-center danger bg-primary bg-opacity-50" width=15% align="left">이름</th>
        <td width=85% class="text-left">
        ${gmboard.writer }
          <%-- <input type="text" name="writer" size=85 value="${gmboard.writer }"> --%>
           <input type="hidden" name="num" value="${gmboard.num }">
        </td>
       </tr>
       ...
       <tr>
        ...
        <td width=85%>
          <input type="text" name="title" size=85 value="${gmboard.title }">
       ...
       <tr>
        ...
        <td width=85%>
        <textarea rows="15" cols="90" name="content">${gmboard.content}</textarea>
        </td>
        </tr>
        <tr>
       ...
       <tr>
        <td colspan="2" class="text-center">
          <input type="submit" class="btn btn-xs btn-success" value="수정">
