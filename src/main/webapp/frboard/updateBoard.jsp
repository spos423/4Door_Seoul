    ...
    <div class="row" style="margin-top: 100px;">
     ...
     <table class="table">
       <tr>
        ...
        ${frboard.writer }
          <%-- <input type="text" name="writer" size=85 value="${frboard.writer }"> --%>
           <input type="hidden" name="num" value="${frboard.num }">
        </td>
       </tr>
       ...
       <tr>
        ...
        <td width=85%>
          <input type="text" name="title" size=85 value="${frboard.title }">
       ...
       <tr>
        ...
        <td width=85%>
        <textarea rows="15" cols="90" name="content">${frboard.content}</textarea>
        </td>
        </tr>
        <tr>
