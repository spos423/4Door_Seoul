...
<body>
	...
	<main class="container-fluid px-0 mb-5" id="main">
		<h5 class="present_location"><img alt="" src="/resources/img/home.png" class="where"> > 여행정보 > 볼거리 > 게시글 작성</h5>
	  	<br>
		...
		<div class="location">
			...
			<div class="board_center">
			  	<form action="t_write_proc.do" method="post" name="boardForm" enctype="multipart/form-data">
					...
					<input type="button" class="btn" value="게시글 등록" onclick="formCheck1()" />
			    </form>
			</div>
		</div>
